...
" visual mode
if version < 700
  hi Visual	guifg=#ffffff	guibg=#002929	gui=NONE
  hi VisualNOS	guifg=#ffffff	guibg=#290029	gui=NONE
else
  hi Visual		guibg=#002929	gui=NONE
  hi VisualNOS		guibg=#290029	gui=NONE
endif
